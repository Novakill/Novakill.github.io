...
function moveSnake() {
 ...
 for ( var i = snake.body.length - 1; i > 0; i-- ) {
    ...
    //console.log("The current snake square is " + currentSnakeSquare)
...
if (snake.head.row === current.row && snake.head.column === current.column ){
  ...
  while (!spaceIsAvailable) {
    ...
    */
       ...
       for ( var i = snake.body.length - 1; i > 0; i-- ) {
         ...
         var currents = snake.body[i];
    
         if (randomPosition.row === currents.row && randomPosition.column === currents.column ){

          console.log("Collision")
         spaceIsAvailable = false;

        } else {spaceIsAvailable = true;}
